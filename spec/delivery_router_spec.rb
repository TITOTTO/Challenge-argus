...
describe DeliveryRouter do
  ...
  describe "#add_order" do
    it 'increments orders' do
      expect(delivery_router.orders.count).to eq 0
      delivery_router.add_order(customer: 1, restaurant: 1)
      expect(delivery_router.orders.count).to eq 1
    end
  ...
  describe "#clear_orders" do
    it 'Delete a customer orders' do
      delivery_router.add_order(customer: 1, restaurant: 1)
      delivery_router.add_order(customer: 1, restaurant: 1)
      expect(delivery_router.orders.count).to eq 2
